...
# Documentação — Personal Wallet API

Esta pasta reúne os artefatos de documentação técnica do projeto.

## Documentos disponíveis

| Documento | Descrição |
|---|---|
| [Escopo do MVP](escopo-MVP.md) | Funcionalidades implementadas, premissas e limites do projeto |
...
1. **[Escopo do MVP](escopo-MVP.md)** — entenda o que foi construído e seus limites.
